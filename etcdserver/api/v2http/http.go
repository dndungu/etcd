...
import (
	...
	"github.com/dndungu/etcd/etcdserver/auth"
	"github.com/dndungu/etcd/pkg/logutil"
...
var (
	plog = capnslog.NewPackageLogger("github.com/dndungu/etcd", "etcdserver/api/v2http")
